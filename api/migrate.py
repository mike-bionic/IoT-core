...
admin = User(username="admin",password="admin123",full_name="Administrator",
	personalTag="C7 95 E1 52",deviceId=1)
db.session.add(admin)

measurement = Measurements(value=122,date=datetime(2020,6,1,2,0,0,0),deviceId=1)
db.session.add(measurement)
measurement = Measurements(value=30,date=datetime(2020,6,1,4,0,0,0),deviceId=1)
db.session.add(measurement)
measurement = Measurements(value=300,date=datetime(2020,6,1,4,0,0,0),deviceId=1)
db.session.add(measurement)
measurement = Measurements(value=87,date=datetime(2020,6,2,4,0,0,0),deviceId=1)
db.session.add(measurement)
